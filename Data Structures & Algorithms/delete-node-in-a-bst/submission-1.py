    ...
    def deleteNode(self, root: Optional[TreeNode], key: int) -> Optional[TreeNode]:
        ...
        # we have found the key
            ...
            #no right child
                ...
                return root.left
            # both children exist; we can use either the
            # smallest node in the right / largest node in the left subtree            
            ...
            #the deleted node with it, the BST still holds.
                ...
                #replace value of current node(which is the node we want to delete)
